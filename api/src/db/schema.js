...
export const auditLogs = pgTable("audit_logs", {
    ...
    beforeData: jsonb("before_data").$type(),
    afterData: jsonb("after_data").$type(),
    ...
    check("audit_logs_metadata_object_check", sql `${table.metadata} is null or jsonb_typeof(${table.metadata}) = 'object'`),
]);
